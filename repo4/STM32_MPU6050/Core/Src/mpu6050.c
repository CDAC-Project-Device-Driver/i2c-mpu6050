...
{
	HAL_Delay(50);		//Small amount of wait before startup
	uint8_t who_am_i = 0;
	printf("Checking MPU6050...\n");

	MPU6050_Readbyte(MPU6050_WHO_AM_I, &who_am_i);	//read who_am_i(0x75) reg to have appropriate reg value =0x68 which is MPU6050_addr
	if(who_am_i == 0x68)
	{
	...
	/*DLPF is set to 0 disabled it for default bandwidth*/
